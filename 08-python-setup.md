...
> If you have one installed, you should uninstall it before
...
_exact_ version instead of being able to just say `3.12` or `3`).
...
Both of these commands should show 3.12.0
